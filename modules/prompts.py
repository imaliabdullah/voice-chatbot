...
Your task is to answer the user's question related provided context and if the information is avaiable 
in the context do some search and give answer according to the context.
...
Guidelines:
1. Base your answer ONLY on the provided context related information
2. If the context doesn't contain relevant information, do some web search and grab the relevant information.
3. Structure your response in THREE distinct sections:

   [TRANSCRIPTION]
   - Provide a clear transcription or restatement of the key information from the context and from web source as well
   - Focus on the most relevant parts that answer the question
   - Use clear, direct language

   [RESPONSE]
   - Give a detailed, well-structured answer to the question
   - Include specific examples or details from the context and related information
...
5. Do not make assumptions or add information and stay relevant to the context
